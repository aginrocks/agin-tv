...
pub struct TvSeriesCredits200Response {
    ...
    pub crew: Option<Vec<models::TvSeriesCredits200ResponseCrewInner>>,
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i32>,
}

impl TvSeriesCredits200Response {
    pub fn new() -> TvSeriesCredits200Response {
