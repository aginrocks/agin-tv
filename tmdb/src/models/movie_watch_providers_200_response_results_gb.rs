...
pub struct MovieWatchProviders200ResponseResultsGb {
    ...
    pub rent: Option<Vec<models::MovieWatchProviders200ResponseResultsGbBuyInner>>,
}

impl MovieWatchProviders200ResponseResultsGb {
    pub fn new() -> MovieWatchProviders200ResponseResultsGb {
