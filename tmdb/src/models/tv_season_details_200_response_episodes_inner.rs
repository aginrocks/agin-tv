...
pub struct TvSeasonDetails200ResponseEpisodesInner {
    ...
    pub crew: Option<Vec<models::TvSeasonDetails200ResponseEpisodesInnerCrewInner>>,
    #[serde(rename = "guest_stars", skip_serializing_if = "Option::is_none")]
    pub guest_stars: Option<Vec<models::TvSeasonDetails200ResponseEpisodesInnerGuestStarsInner>>,
}

impl TvSeasonDetails200ResponseEpisodesInner {
    pub fn new() -> TvSeasonDetails200ResponseEpisodesInner {
